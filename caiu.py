# Obter informações do Codespaces Secrets
...
try:
    ...
    os.system("pip install youtube-dl requests beautifulsoup4 fastapi uvicorn schedule selenium datetime google-auth google-api-python-client")
